...
const nobot = "6281905091832" // Ganti No Bot Kalian
const namabot = "Demony MD" // Ganti Nama Bot Kalian
const nameown = "Zens ID" // Ganti Nama Kalian
const numown = "0881-6322-738" // Ganti Nomor Kalian
const nameowner = "Zens" // Ganti Nama Kalian
const footer = "Ｄｅｍｏｎｙ ＢＯＴ - ＭＤ" // Ganti Nama Bot Kalian
const capt = "*By Zens Bot MD*" // Ganti Nama Bot Kalian
const grup = "https://chat.whatsapp.com/JqV2AEbC6TWIsnEMFNIYJi" // Ganti Link Group Kalian
const nomorown = "https://wa.me/628816322738" // Ganti Nomor Kalian
const note = "*_Bot Ini Masih Dalam Pengembangan Jika Ada Fitur Yang Eror Mohon Di Maklumii!!!_*" // Kalau Mau Ganti Aja
const namagrup = "Group Demony MD" // Ubah Nama Group Mu

// Setting Donasi
const gopay = "0881-6322-738" // Ganti Nomor Gopay Mu
const pulsa = "0881-6322-738" // Ganti No Pulsa Mu
const insta = "-" // Ganti Nama IG Mu
const github = "GH-Zens" // Ganti Nama Github Mu
const linkdonasi = "https://telegra.ph/file/bfb025bbdb80c006d1527.jpg" // Ganti Link Qris Mu

// Setting SewaBot Ubah Harga Sesuai Harga Mu//
const qris = "https://telegra.ph/file/bfb025bbdb80c006d1527.jpg"
const nomor = "wa.me/628816322738"
...
const diamondsatu = "50 💎 = 6.552"
const diamonddua = "70 💎 = 9.009"
const diamondtiga = "100 💎 = 13.104"
const diamondempat = "140 💎 = 18.018"
const diamondlima = "355 💎 = 45.045"
const diamondenam = "720 💎 = 90.090"
...
module.exports = async(conn, msg, m, setting, store) => {
    ...
    const readmore = more.repeat(4001)
		...
		const isOwner = ownerNumber == sender ? true : [`${ownerNumber}@s.whatsapp.net`, "628816322738@s.whatsapp.net"].includes(sender) ? true : false
...
if (chats.startsWith("@628816322738")){
...
case prefix+'donasi':
  case prefix+'donate':
  var donasibut = [
			{ urlButton: { displayText: `Group Demony Bot`, url : `${grup}` } },
...
*Script : https://youtube.com/channel/UCTVeRHM0v0Hqv_-O8yVkFpw*`
...
⚠️ Segala kebijakan dan ketentuan Demony Bot di pegang oleh owner dan segala perubahan kebijakan, sewaktu waktu owner berhak mencabut, memblokir user(*﹏*)

Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan Demony Bot
😖🙏`
...
case prefix+'claim': //By Christian ID
  ...
  break
case prefix+'groupDemony':
  reply(`Group Demony Bot\n${grup}`)
  break
			case prefix+'speed':
			  reply("Testing Speed...")
			    let timestamp = speed();
...
case prefix+'githubown':
 ...
 break
            ...
            case prefix+'cekpremium':
                ...
                if (isOwner) return reply(`Lu owner gw bego!`)
			...
			{ quickReplyButton: { displayText: `Ubah Ke Audio`, id: `${prefix}tiktokaudio ${q}` } },
				...
				reply(mess.wait)
				conn.sendMessage(from, { caption: `Succes Download Video Tiktok, Thanks For Using Demony-Bot!`, video: {url: data.nowm}, templateButtons: tidtod, footer: `${footer}`, mentions: [sender]} )
			}).catch(() => reply(mess.error.api))
			limitAdd(sender, limit)
			    break
...
case prefix+'wame':
if (isLimit(sender, isPremium, isOwner, limitCount, limit)) return reply (`Limit kamu sudah habis silahkan kirim ${prefix}limit untuk mengecek limit`)
if (args.length < 2) return reply(`Kirim perintah ${command} 62881xxxxxxxx`)
...
conn.sendMessage(from, { text: slotnya, buttons: but, footer: "© Slot By Zens\n@DemonyMD", templateButtons: but }, {quoted: msg})
gameAdd(sender, glimit)
        break
case prefix+'cekme':
  case prefix+'me':
