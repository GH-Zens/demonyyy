...
console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Powered By Zenss ]')}\n\n${chalk.red('Demony-Bot')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@Gapunya IG')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('+62881-6322-738')}\n${chalk.red('Donate')} : ${chalk.white('08816322738 ( Gopay/Pulsa )')}\n`))
}
